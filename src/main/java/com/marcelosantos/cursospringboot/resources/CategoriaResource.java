...
import com.marcelosantos.cursospringboot.services.CategoriaService;
...
public class CategoriaResource {
	...
	@ApiOperation(value="Deleta a categiria por ID")
	@ApiResponses(value = {
	...
	@ApiOperation(value="Localiza todas as categorias")
